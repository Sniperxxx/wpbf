...
banner();
system("title Developed By BLACK_CODE");
...
print color('bold red'),"v1.2\n\n";
print color('bold red'),"\t\t        [";
print color('bold white'),"Developed By BLACK CODE";
print color('bold red'),"]\n";
print color('reset');
};
$a = 0;
sub help {
print q(
Usage:  perl MBrute.pl -l list.txt -p passwords.txt
